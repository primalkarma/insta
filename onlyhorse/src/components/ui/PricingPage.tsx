...
export const frequencies: PricingTierFrequency[] = [
  ...
  { id: '3', value: '3', label: 'Daily', priceSuffix: '/day' },
];
...
export default function PricingPage() {
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center mt-6 pt-24 sm:pt-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          <div className="w-full lg:w-auto mx-auto max-w-4xl lg:text-center">
            ...
            <p className="text-black dark:text-white mt-6 md:text-xl lg:text-center max-w-prose">
              We strive to provide the best value for money...
            </p>
          </div>
