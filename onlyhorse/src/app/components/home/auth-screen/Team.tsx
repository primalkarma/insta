...
const Team = () => {
  return (
    <section className='container mx-auto py-24 sm:py-32'>
        ...
        <p className='mt-4 mb-10 text-md md:text-5xl text-muted-foreground text-center'>
            Meet the passionate individuals who work tirelessly to ensure the best care and training for our horses.
        </p>
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8 gap-y-10' >
            {teamList.map(({description, imageUrl, name, position}) => (
                <Card key={name} className='flex flex-col items-center justify-center mt-7 bg-muted/50 relative'>
                    <CardHeader className='my-8 justify-center items-center pb-2'>
                        <img src={imageUrl} alt="Team member" className='absolute -top-12 rounded-full w-24 h-24 aspect-square object-cover' />
